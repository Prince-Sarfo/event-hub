...
class StudentNavView extends StatefulWidget {
  const StudentNavView({super.key});

  @override
  State<StudentNavView> createState() => _StudentNavViewState();
}

class _StudentNavViewState extends State<StudentNavView> {
  int currentIndex = 0;
